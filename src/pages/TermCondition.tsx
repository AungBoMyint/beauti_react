...
const TermCondition = () => {
  return (
    <Box>
      ...
      <Text m={2}>
        OVERVIEW This application and website is operated by Delux Beauti.
        Throughout the site, the terms “we”, “us” and “our” refer to Skin Cupid.
        Skin Cupid offers this website, including all information, tools and
        ...
        changes. SECTION 1 - ONLINE STORE TERMS By agreeing to these Terms of
        ...
        Services. SECTION 2 - GENERAL CONDITIONS We reserve the right to refuse
        service to anyone for any reason at any time. You understand that your
        ...
        sell, resell or exploit any portion of the Service, use of the Service,
        ...
        will not limit or otherwise affect these Terms. SECTION 3 - ACCURACY,
        COMPLETENESS AND TIMELINESS OF INFORMATION We are not responsible if
        ...
        site is at your own risk. This site may contain certain historical
        ...
        monitor changes to our site. SECTION 4 - MODIFICATIONS TO THE SERVICE
        AND PRICES Prices for our products are subject to change without notice.
        ...
        change, suspension or discontinuance of the Service. SECTION 5 -
        ...
        an order, we may attempt to notify you by contacting the email and/or
        ...
        review our Returns Policy. SECTION 7 - OPTIONAL TOOLS We may provide you
        with access to third-party tools over which we neither monitor nor have
        any control nor input. You acknowledge and agree that we provide access
        ...
        third-party products should be directed to the third-party. We
        occasionally use third party content may infringe on another's copyright
        and so have a take down procedure to ensure that we are in accordance
        and are respectful to said owner. SECTION 9 - USER COMMENTS, FEEDBACK
        ...
        related website. You may not use a false email address, pretend to be
        ...
        our Privacy Policy. SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS
        ...
        website for violating any of the prohibited uses. SECTION 13 -
        ...
        durability, title, and non-infringement. In no case shall Skin Cupid,
        ...
        INDEMNIFICATION You agree to indemnify, defend and hold harmless Skin
        Cupid and our parent, subsidiaries, affiliates, partners, officers,
        ...
        party. SECTION 18 - GOVERNING LAW These Terms of Service and any
        separate agreements whereby we provide you Services shall be governed by
        and construed in accordance with the laws of Union Of The Republic Of
        Myanmar. SECTION 19 - CHANGES TO TERMS OF SERVICE You can review the
        ...
        INFORMATION Please contact us by e-mail at deluxbeauti@deluxbeauti.com
      </Text>
    </Box>
  );
};
